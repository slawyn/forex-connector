...
class Trader:
    ...
    MT_TIMEFRAMES = [mt5.TIMEFRAME_M2,mt5.TIMEFRAME_M3,mt5.TIMEFRAME_M4,mt5.TIMEFRAME_M5,mt5.TIMEFRAME_M6,mt5.TIMEFRAME_M10,mt5.TIMEFRAME_M12,mt5.TIMEFRAME_M20,mt5.TIMEFRAME_M30,mt5.TIMEFRAME_H1,mt5.TIMEFRAME_H2,mt5.TIMEFRAME_H3,mt5.TIMEFRAME_H4,mt5.TIMEFRAME_H6,mt5.TIMEFRAME_H8,mt5.TIMEFRAME_H12,mt5.TIMEFRAME_D1,mt5.TIMEFRAME_W1,mt5.TIMEFRAME_MN1]
    ...
    def send_order(self, symbol, type, volume, price, sl, tp, stoplimit, comment=""):
        try:
            result = mt5.order_send(action=action, magic=magic, order=order, symbol=symbol,  volume=volume, price=price, stoplimit=stoplimit, sl=sl, tp=tp, deviation=deviation, type=type, type_filling=type_filling, type_time=type_time,expiration=expiration, comment=comment,position=position,position_by=position_by)
        except Exception as e:
            log(e)
        pass
